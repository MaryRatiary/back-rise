...
RUN dotnet publish "Rise.API/Rise.API.csproj" -c Release -o /app/publish /p:UseAppHost=false
...
# Expose port (Render uses dynamic port assignment via PORT env var)
EXPOSE 5000
